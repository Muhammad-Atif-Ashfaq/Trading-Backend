...
class CheckStopOutLevels extends Command
{
    /**
    ...
    {
        $accounts = TradingAccount::where('status',TradingAccountStatusEnum::MARGIN_CALL)->get();
        foreach ($accounts as $account) {
            if ($account->margin_level_percentage < $account->brand->stop_out) {

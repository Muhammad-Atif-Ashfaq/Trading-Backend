...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('/group_transaction_orders', GroupTransactionOrderController::class)->parameters([
        'group_transaction_orders' => 'transaction_group_order'
    ]);
    ...
    Route::apiResource('/group_trade_orders', GroupTradeOrderController::class)->parameters([
        'group_trade_orders' => 'trade_group_order'
    ]);
